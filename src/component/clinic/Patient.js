    ...
    return (
        <Box sx={{margin: 1}}>
            <Box sx={{ display: 'flex', alignItems: 'center', marginBottom: 1 }}>
                접수번호
                <TextField disabled size='small' value={reception} sx={{ width: 100 }}/>
                환자이름
                <TextField disabled size='small' value={patient.patient_name} sx={{ width: 120 }}/>
                주민등록번호
                <TextField disabled size='small' value={patient.front_registration_number} sx={{ width: 100 }}/>
                -
