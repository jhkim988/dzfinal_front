...
const PatientForm = ({ setPatient_id, patientData, setPatientData, setReceptionData, selectedAddress, setSelectedAddress }) => {
    ...
    const selectedSearchPatient = (patient_id) => {
        //alert(patient_id);
        if (window.confirm("[ 환자번호 : " + patient_id + " ]" + patientData.patient_name + "님의 환자 정보를 보시겠습니까?")) {
                                    ...
                                    <Table style={{ width: "200px", height: "10px" }}>
                                        <TableBody>
                                            ...
                                            <TableBody>
                                                ...
                                                <TableCell colSpan={3} align="right" style={{ paddingTop: 4, paddingLeft: 2, paddingRight: 2 }}>
                                                    <Button variant="contained" style={{ height: 20 }} onClick={() => { removeAutoCompleteList(); }}>닫기</Button>
                                                </TableCell>
                                            </TableBody>
                                        </Table>
                                    </div>
                ...
                <Paper sx={{ height: "24vh" }} elevation={1}>
                    ...
                    <div style={{ marginTop: "1em", marginLeft: "1em" }}>
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={2} sx={{ marginLeft: 0.5 }}>
                                <Box sx={{ display: "flex", justifyContent: "space-around" }}>
                                    <Button type="submit" onClick={handleSubmit} variant="contained" style={{ width: "30px", height: "30px" }}>수정</Button>
                                    <Button type="reset" variant="contained" color="error" onClick={resetHandler} style={{ width: "30px", height: "30px", marginRight: "5px" }}>취소</Button>
                                </Box>
                            </Grid>
                        </Grid>
